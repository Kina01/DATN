...
public class ScheduleDTO {
    ...
    public static class ScheduleResponse {
        ...
        public SubjectDTO.SubjectResponse getSubject() {
            return subject;
        }

        public void setSubject(SubjectDTO.SubjectResponse subject) {
            this.subject = subject;
        }

        public ClassSimpleDTO getClassInfo() {
            return classInfo;
        }

        public void setClassInfo(ClassSimpleDTO classInfo) {
